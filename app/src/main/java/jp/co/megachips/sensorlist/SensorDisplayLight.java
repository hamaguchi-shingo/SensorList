 ...
 */
public class SensorDisplayLight extends SensorDisplayBase {
    ...
    public void setUI(Activity activity) {
        timestampTextView = (TextView)activity.findViewById(R.id.lightTimestampTextView);

        valueTextView[0] = (TextView)activity.findViewById(R.id.lightTextView0);
    }
